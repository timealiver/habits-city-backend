export const MESSAGES = {
    ...
    ru: {
      ...
      error: {
        ...
        INVALID_DATA: "Предоставлены некорректные данные.",
        SAME_PASSWORD:"Пароли не могут быть одинаковы.",
        EMPTY_FIELDS: "Пустые поля.",
        INVALID_OLD_PASSWORD: "Старый пароль был введен неверно.",
        NOT_AN_EMAIL:"Предоставленная строка не является почтой.",
